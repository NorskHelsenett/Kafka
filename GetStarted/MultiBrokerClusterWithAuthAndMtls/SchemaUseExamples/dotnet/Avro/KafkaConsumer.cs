...
public class KafkaConsumer : BackgroundService
{
    ...
    public KafkaConsumer(ILogger<KafkaConsumer> logger, ConsumedState consumedState)
    {
        ...
        var topicName = Environment.GetEnvironmentVariable("PERSONS_AVRO");
        if(string.IsNullOrEmpty(topicName))
        {
            topicName = "persons-avro";
        }
        _topic = topicName;
    }
    ...
    private IConsumer<string, Person> GetConsumer()
    {
        ...
        {
            sslCaPemLocation = "../../../ContainerData/GeneratedCerts/Kafka/Users/avro-user/ca.crt";
        }
        ...
        {
            sslCertLocation = "../../../ContainerData/GeneratedCerts/Kafka/Users/avro-user/acl-principal.crt";
        }
        ...
        {
            consumerGroup = "persons-avro-group";
        }
