...
{
    public const string SCHEMA_EVOLUTION_V1_TOPIC = nameof(SCHEMA_EVOLUTION_V1_TOPIC);
    public const string SCHEMA_EVOLUTION_V2_TOPIC = nameof(SCHEMA_EVOLUTION_V2_TOPIC);
