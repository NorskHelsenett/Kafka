...
throw new NotImplementedException("Create a new schema with breaking changes and put it's path here");
var thirdSchemaAsString = File.ReadAllText("./Protos/your-new-version-here.proto");
...
throw new NotImplementedException("Use your newly created schema with breaking changes and make and send a payload!");
